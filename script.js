...
const posters = {
    horror: {
        ...
        2: {
            title: "Indigo",
            description: "A family faces a dark presence in their farmhouse.",
    ...
    drama: {
        ...
        2: {
            title: "Parasite",
            description: "A family that chooses to become parasites and harm another family to avoid living under a basement.",
    ...
    series: {
        1: {
            title: "Squid Game",
            description: "A game with a huge prize and life-threatening stakes.",
            image: "https://i.pinimg.com/236x/23/cc/bf/23ccbf28137082dc795cf308f74f5ec0.jpg",
            links: [
                { text: "Watch Trailer", url: "https://www.youtube.com/watch?v=linkdisini" },
                { text: "More Info", url: "https://www.imdb.com/title/tt10954600/" }
            ]
        },
    }
};
...
// Fungsi untuk membuat elemen poster horizontal
...
// Fungsi untuk menampilkan poster horizontal
